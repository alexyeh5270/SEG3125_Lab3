# SEG3125 - AAM Grocery Store 

This is Lab 3 for SEG3125.  This was created using HTML, CSS, and Javascript.

There are three main sections for the website:
...
## Cart
The user is able to see all the products, quantities, and prices of the products they put into their cart.  They are also able to see the total price of all the groceries in their cart.